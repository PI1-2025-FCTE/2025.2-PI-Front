            ...
            (<div className="min-h-screen w-full bg-[#1E1E1E]">
                ...
                <div className="flex my-10 mx-10 h-[600px]">
                    <div className="flex flex-col gap-10">
                        ...
                        {!connection &&
                        (<div className="mt-[220px] h-[100px] w-[400px] bg-[#7398B7] rounded-xl flex items-center justify-center transition hover:scale-[1.02]">
                            <h1 className=" text-white font-bold text-[25px]">RECONECTAR</h1>
                        </div>)}
                        {connection && !disponibility && (<div className="mt-[220px] h-[100px] w-[400px] bg-[#7398B7] rounded-xl flex items-center justify-center transition hover:scale-[1.02]">
                            <h1 className=" text-white font-bold text-[25px]">PARAR TRAJETO</h1>
                        </div>)}
                    </div>
